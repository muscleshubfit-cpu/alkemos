...
---
Task ID: EMBER-INK-279-2026-09-26
Agent: Super Z (owner session)
Task: تنفيذ إعادة تصميم واجهة Alkemos بأمر المالك 2026-09-26: قالب 1devtool landing-fitness-studio (https://1devtool.com/templates/landing-fitness-studio — المصدر المفتوح stoicsoft/1devtool-templates) هو أساس التصميم الفعلي لا مجرد مرجع — نقل الرموز والوصفات والأقسام كما هي مع تكييفها مع Next.js 16/Tailwind 4، مع الاحتفاظ الكامل بكل الوظائف والبيانات والمسارات وSupabase/EVO/الأدوات/التمارين/الأطعمة/العضويات/PWA/SEO، وبإبقاء لوجو Alkemos وصورة الهيرو فقط من الهوية القديمة.

Work Log:
- (الفحص أولًا) git fetch — SYNCED على 97c0725 (نهاية V8R) · قراءة STATE/AGENTS/DESIGN + الكاناريين · تنزيل مصدر القالب من مستودع 1devtool-templates وقراءة ملفاته الثلاثة كاملة (globals.css/page.js/layout.js) لاستخراج النظام كما هو: ألوان ink/surface/surface-2/line/cream/ember/ember-2/acid · خطوط Sora+Outfit · تأثيرات marquee/glow-ember/noise/dot-pulse · بنية الأقسام (هيرو شبكة 1.15/0.85 + ماركيه + برامج مرقمة + split-feature + جدول + كوتشز + أسعار + FAQ + CTA + فوتر).
- (القرار المعماري) الزرع على طبقتين: (أ) طبقة الرموز — globals.css يحل Marble&Chrome إلى Ember&Ink بنفس أسماء المتغيرات والوصفات (123+ موضع استخدام ينتقل دفعة واحدة بلا إعادة اختراع نظام) · (ب) طبقة الأقسام — LandingView يعاد هيكلته على بنية القالب الحرفية مع إبقاء كل المحركات التفاعلية (الحاسبة/EVO/البانيان/المتصفحان) كما هي.
- (الخطوط) root-shell.tsx: Playfair→Sora وInter→Outfit عبر next/font (متغير واحد لكل عائلة، preload كما كانا) — القاهرة تليهما في الستاك فيحل كل محرف عربي إليها (قانون RTL V0 سليم: الاختبار معاد تثبيته على Sora/Cairo/Outfit).
- (الرموز — :root و[data-theme=dark]) القالب داكن فقط: كتلتا الثيم تحلان لنفس لوحة ink #08080A/cream #F7F3EC/ember #FF4D26-#FF9353/acid #D7FF4D + surface/surface-2/line + --chrome=تدرج ember أفقي + --radius-chrome=24px (rounded-3xl) + color-scheme: dark بالوضعين — المفتاح يظل يعمل والهوية شكل واحد موثق.
- (الوصفات) btn-chrome=حبة ember بتوهجها وظلمتها #1A0E0A (حذف سويب chrome-shiny والbevel مع القانون: الميت يحذف بنفس الفريم) · btn-outline=white/20→white/50 · marble-card=كارت القالب (تدرج white/4→1 + شعري white/10 + 24px) وcard-lift=white/30 · seal-chip/hero-pill=شارة زجاجية القالب · chrome-text=تدرج ember 145° · footer-marble=#0A0A0C+شعري white/5 · shim الفاتح صار mode-invariant (لا وميض أبيض لزوار light) · الجديد: ember-panel/glow-ember/noise/tpl-marquee (RTL reverse + reduced-motion)/dot-pulse/hero-glow/hero-row.
- (المتقاعد بحذف كوده) meander-divider وfooter-meander-top (الهوية اليونانية غائبة عن القالب) · hero-art/hero-bg/hero-copy (الهيرو تغير لبنية القالب) · platform-trio/trio-* (قصة الأعمدة تنتقل لصفوف كارت الهيرو) · typography الأساس: عناوين bold 700 بtracking القالب.
- (LandingView — الهيرو) شبكة القالب: شارة hero-pill بنقطة dot-pulse (EVO LIVE) → اللوجو المحفوظ → H1 clamp(2.5rem,6vw,4.75rem) بleading-[0.95] (utils الر RTL كما هي) → الوصف → زرا القانون الثابتان → صف إحصاءات القالب (طي شريط الإثبات المستقل: نفس الأرقام الأربعة والCountUp وaria-label) · كارت جانبي زجاجي: صورة الهيرو المحفوظة بإطار القالب + glow خلفه + أعمدة المنصة الثلاثة كصفوف hero-row + صف ONE PLATFORM · ثم شريط الماركيه (border-y black/40) بمفردات المنصة باللغتين (aria-hidden).
- (الأقسام) الترويسات المقسمة (eyebrow يسار + عنوان display bold + وصف يمين بعناصر flex-wrap justify-between) · #evo صار لوحة القالب الكبيرة (ember-panel متدرج rounded-32 بنص داكن) بفن المحارب والكونسول كما هما · #train شبكة برامج مرقمة 01/02/03 (رقم شبحي + صورة + صف meta بشعري علوي) بدل الكاروسيل · #diet شبكة 4 أعمدة · #memberships بطاقات أسعار القالب (بريميوم مميزة بحلقة ember + شارة موصى بها + توهج) بنفس اشتقاق الأسعار من memberships.ts وصفات المزايا · كوتشز مميزون ببطاقة كوتش القالب (إطار 4/5 + سهم دوّار) · FAQ بعمودين وغلاف marble-card · CTA ختامي جديد بصف القالب (radial glows + زر حساب + EVO عبر openEvoFloatingChat — لا نموذج بريد زائف) — إلغاء CTA 270-R8 مُسقط بأمر المالك الجديد هذا (القالب أساس) وموثق بالكاناري.
- (الهوية المحفوظة/المتغيرة) اللوجو (أزواج header/hero/footer/mark) وصورة الهيرو فقط — كما أمر المالك؛ البقية (الرخام/الكروم/الميندر) تقاعدت حيث تعارضت مع القالب · metadata themeColor=زوج ink · manifest PWA: background #08080A وtheme #FF4D26 · preloads الهيرو توجه للن اللوجو/الصورة الداكنين (المستخدمون فعليًا).
- (الكاناري — إعادة تثبيت §21.3 بنفس الفريم) homepage-adoption: صف الإحصاءات الجديد · فئة card-lift الجديدة · فئة أكورديون FAQ · +3 فحوص قالب جديدة (الوصفات بالCSS/الصفحة · المتقاعد ميت بالتظهير الانتقائي للتعليقات · CTA الختامي بشروطه · الشبكات بدل الكاروسيلين) = 33/33 · rtl-typography: ستاك Sora/Outfit + leading-[0.95] + زوج themeColor الجديد = 9/9.
- (البوابات §3.5) tsc ✓ 0 · eslint ✓ 0 (تحذير root-shell القديم وحده كما وثّق 278) · vitest ✓ 100/1708 (+3) · contrast matrix ✓ كله (نص ≥6:1 · حبر الزر 5.71–8.6 · أشرطة 5.71 L*) · docs_audit ✓ صفر مخالفات (بعد اكتمال تاريخ git المحلي — إخفاقات الاستنساخ الضحل كانت قياسًا زائفًا وثّقت كدرس) · next build ✓ exit 0 بـ2020/2020.
- (درس parity) تشغيل docs_audit قبل الكوميت قارن تواريخ الملفات بآخر كوميت لها في التاريخ القديم — صف src/docs/DESIGN_SYSTEM.md ظل 2026-09-25 ففشلت بوابة parity على CI بعد الكوميت (الملف صار آخر كوميته اليوم) — الإصلاح: صفوف السجل (DESIGN_SYSTEM/README/docs/README) رُفعت لتواريخ ملفاتها الفعلية بفريم متابعة، والدرس: صفوف السجل تُحدَّث قبل كوميت الملفات التي تلمسها.
- (الحي محليًا) EN/AR × 1440/390 على dev: صفر overflow أفقي (scrollWidth=viewport بالأربع سياقات) وصفر أخطاء console · الحاسبة نقرت فعليًا وظهرت النتيجة بلا NaN · VLM تحقق: الهيرو بكل عناصر القالب (شارة/لوجو/H1/زران/إحصاءات/كارت زجاجي بصورة وصفوف) · الأقسام بترويساتها المقسمة وبطاقاتها وشبكاتها المرقمة · بطاقات الأسعار بالمميزة والحلقة والشارة · فوتر داكن ب5 أعمدة · العربية RTL سليمة الحروف والانعكاس.
...
Agent: Super Z (owner session)
Task: تنفيذ P0+P1 فقط من موجة VRD-V7 «لحظات حية» (أمر المالك 2026-09-26 بناءً على تقرير تدقيق الرئيسية الخارجي + أبحاث 21st.dev — البنود: إصلاح شفافية الهيدر · دمج Shiny داخل chrome-btn · تطوير EVO بSiri Orb + Border Beam · ترقية CountUp بزنبرك/ضبابية · بانتو قسم بناء الخطط — دون أي بند P2، دون Framer Motion/GSAP/Three.js/WebGL/Canvas، ودون مساس بمنطق الأعمال/API/Supabase/المسارات).

Work Log:
- (المراجعة أولًا) قراءة STATE/DESIGN/AGENTS + LandingView.tsx (2645 سطرًا) وSiteHeader وglobals.css كاملين + اختبار الكاناري homepage-adoption حرفيًا لجرد النصوص المثبتة (زرا الهيرو · const shown = display ?? value · saveGuestPlan ×2 · maxLength×2 · أزرار #plan) — تأكيد عدم إعادة تنفيذ ما هو سليم وأن كل وظيفة ستبقى حرفية.
- (P0-1 الهيدر) ‎--navbar-bg‏ ‏0.85→0.94 بالوضعين + تدرج سفلي ‎.navbar-chrome::after‏ ‏24px من ‎color-mix(--bg)‎ — **واكتشاف جوهري أثناء التحقق البصري: blur(12px) كان ميتًا إنتاجيًا** — Lightning CSS (بناء Tailwind v4) يدمج الزوج القياسي/‎-webkit‎ ويُبقي الأخير، فالترتيب القياسي-أولًا كان يسلّم ‎-webkit-‎ فقط الذي يحسبه Chromium ‏none — أعيد الترتيب ‎(-webkit‎ أولًا) في ‎.navbar-chrome‎ و‎.btn-outline‎ على نسق ‎.hero-pill‎/‎.mhe-cookie-bar‎ الناجي — الضبابية عادت فعليًا (اللقطة قبل/بعد: نص الشريط الشبح اختفى كليًا).
- (P0-2 اللمعة) ‎.btn-chrome::before‏ شريط إبهار قطري يجتاز المعدن كل ~4.5s (المسح في أول 38% من الدورة ثم سكون) — CSS خالص على transform فقط بلا أي اعتمادية (مصدر 21st.dev «Shiny Button» منسوخ داخليًا) · قلب الاتجاه بـ[dir=rtl]‎ بمفتاحي keyframes ومنحدر مرآة · حارس reduced-motion يخفيه · ‎overflow:hidden‎ + position:relative لا يقصان الظلال/حلقة التركيز (تُرسم خارج الصندوق).
- (P1-3 زوج حضور EVO) ‎.evo-orb‏ ‏22px كرة زجاجية (قبعة بيضاء عاكسة + نواة ‎--ai‎ + عمق غرافيتي + دوامة conic تدور transform-only) في ترويسة ‎.evo-console‏ مع كلمة EVO وlive-dot · ‎.evo-beam/.evo-beam-rotor‏ حلقة 1.25px masked (mask-composite exclude) قوسها السياني + ذيله الكرومي يطوف حدود اللوحة بدوران عنصر متضخم — مُغلّفة ‎@supports‎ فتختفي كليًا بلا دعم (تحسين تدريجي) — كل السيان محصور بسطح AI (القانون محفوظ) وحارسا reduced-motion لكل keyframe.
- (P1-4 الأرقام) CountUp الداخلي ترقّى بـrAF نفسه: زنبرك easeOutBack (c1=0.7 ≈ تجاوز 5%) + ضبابية تتبلور مع الهبوط (filter فقط) عبر ‏1100ms · قشرة count-shell/count-sizer/count-live: الشبح يحجز عرض القيمة النهائية في التدفق والأرقام المتحركة طبقة مطلقة — **صفر CLS** · الأرقام المتحركة aria-hidden والقيمة النهائية تُعلن مرة بـ.sr-only · paintClass ينقل chrome-text إلى الطبقتين (اكتشاف التحقق: background-clip:text للأب لا يقص لسلال خارج التدفق — الأرقام اختفت وأُصلحت بنقل التدرج للطبقة نفسها).
- (P1-5 بانتو #plan) البطاقتان تقرآن كوحدات شعرية هادئة (planTile بلا تعبئة — منطقة الإجابة تبقى الأعلى صوتًا): هدف (عرض كامل) / مستوى | أيام / معدات (عرض كامل) / ملاحظات، ووحدة التغذية سعرات | نظام / ملاحظات · شبكة القسم تُغلق بشريط الرصيد الشهري بعرض كامل + شارة «توليد حقيقي داخل الصفحة» (النقلة من نثر الترويسة إلى نقطة الفعل) · تخفيف الحشو md:p-7→md:p-6 — **صفر تغيير وظيفي**: نفس الحقول والمعالجات والمسارات وsaveGuestPlan وCTAs (الكاناري 273 مثبت عليها حرفيًا).
- (التحقق) tsc ✓ 0 · eslint ✓ 0 (تحذير واحد قديم بملف غير مساس) · vitest ✓ 100/1702 (الكاناري كله أخضر بلا تعديل عليه) · contrast matrix ✓ · stale-refs ✓ · ui-wiring ✓ · migration_audit ✓ · docs_parity ✓ · **next build ✓ 2020/2020 — اكتمل بالكامل داخل الـsandbox هذه المرة** (بخلاف 275 الذي قُتل OOM) · docs_audit: **صفر مخالفات جديدة** (30 قديمة من فحصي J/M على كوميتات 2026-09-21 — CI الأخضر عليها كما هي) · DESIGN.md §5/§7.3 محدثة بوصفات V7 · STATE ضُغط ضمن السقفين.
- (الحي محليًا عبر headless) EN/AR × Light/Dark × 1440/390: هيدر بلا أي تسرب نصي + الشعاع يطوف الحدود + الأورب يتنفس + اللمعة تلمع زر Accept + بانتو سليم بلا overflow أفقي + صفر أخطاء console/hydration — لقطة الجوال التقطت زنبرك 870+ أثناء تسويته إلى 868+ (دليل بصري مباشر على التأثير) — اللقطات محفوظة خارج المستودع.

Stage Summary:
- موجة VRD-V7 ‏P0+P1 منفذة كاملة: هيدر محكم (0.94 + تدرج + blur مُحيى) · زر كرومي يلمع · EVO حي بالأورب والشعاع · أرقام تتحرك بزنبرك بلا CLS · #plan بانتو أخف وأوضح — **كلها CSS خالصة على transform/filter، صفر اعتماديات جديدة، صفر مكتبات حركة، صفر مساس بمنطق الأعمال/المسارات/API/Supabase/الأسرار**.
...
Agent: Super Z (owner session)
Task: إعادة تصميم Alkemos.com بصريًا وUX كموجة VRD-V6 «الصقل العالمي» (أمر المالك 2026-09-25: تدقيق فعلي أولًا ثم تطوير الهوية الحالية Chrome/Silver + Graphite + Ivory دون استبدال — Hero يوضح المنصة المتكاملة Fitness+Nutrition+AI، مع الحفاظ على كل الوظائف والـbusiness logic).

Work Log:
- (التدقيق أولًا) فحص المستودع (AGENTS/STATE/DESIGN/globals.css/LandingView كاملًا + الكانارييات) والموقع الحي alkemos.com عبر headless browser في 6 سياقات (EN/AR × Light/Dark × 1440/390) + جولتَي VLM تدقيق (قبل/بعد) — النتيجة: نظام Marble & Chrome الدافئ (VRD-V1→V5) مطابق للاتجاه المطلوب؛ الهيكلة والوظائف والـRTL سليمة (كايرو H1 مؤكد محسوبًا)؛ نقاط الضعف المُصادق عليها: affordance الزر الأساسي، غياب قصة المنصة المتكاملة هيكليًا من الـHero، ازدواج السطوح الداكنة بقسم العضويات، بطاقات الأنظمة الغذائية نصية صرفة، فقاعات EVO عائمة عامة الشكل.
- (globals.css) .btn-chrome: حلقات داخلية مشطوفة (inset top light/bottom dark) + تعميق الظل بالـhover إلى --shadow-lift — إحساس «معدن مضغوط» قابل للنقر دون مساس بالتدرج الكرومي · .btn-outline: تعبئة 65%←72% · جديداً .hero-pill (رقائق زجاجية للثلاثية — بلا letter-spacing احترامًا لقانون الكتابة المتصلة) و.evo-console (لوحة منتج tint-glass بحافة hairline) و.split-rail/.split-seg--* (سكة توزيع الماكروز 6px بمقاطع color-mix من --text تنقلب تلقائيًا مع الثيم).
- (LandingView) الـHero: ثلاثية المنصة كقائمة دلالية غير تفاعلية (التدريب/التغذية/التخطيط الذكي بأيقونات EngravedIcon dumbbell/protein/macros) بين الوصف والزرين — قانون الزرين سليم حرفيًا · قسم EVO: المحادثة داخل evo-console مع فقاعة المستخدم bg-card وEVO avatar بـai-ring (قانون السيان لأسطح AI فقط) · بطاقات الأنظمة الغذائية: سكة split-rail بنسب system.split الحقيقية + الأرقام نصًا تحتها (نفس البيانات، لغة بصرية موحدة مع #eat) · كارت الكوتشينج: من darkMarbleStyle إلى شريط خدمة فاتح (--tint + --edge) فأصبح Premium المرساة الداكنة الوحيدة بالقسم — النصوص والروابط والسعر وCTA الكروم حرفيون (الكاناري 273 مثبت عليها).
- (النظام والتوثيق — بأمر المالك الصريح) جديداً src/styles/design-tokens.ts (مرآة نوعية للتوكنز: ألوان/كروم/AI/حالة/أنصاف أقطار/حركة/طباعة/إيقاع/وصفات — globals.css يبقى المصدر الوحيد للتنفيذ) وsrc/docs/DESIGN_SYSTEM.md (مرجع النظام التنفيذي: الفلسفة، التوكنز، الوصفات، وصفات الصفحات، محرك الثيم، قوانين RTL/الوصولية، بروتوكول التحقق) · DESIGN.md حُدث: §2 مؤشر المرآتين + §5 (تحديث btn-chrome/btn-outline، إضافة hero-pill/evo-console/split-rail، حذف صف footer-disc المتقاعد) + §7.1 (قانون زرَي 270 + فقرة الثلاثية V6) + §7.4 (وصف العضويات الفعلي 270/271 + شريط الكوتشينج الفاتح) — أُغلقت به انجرافات توثيقية قديمة من عهد 269.
- (التحقق) tsc ✓ 0 · eslint ✓ 0 · vitest ✓ 100/1702 (الكاناريان homepage-adoption وrtl-typography كلاهما أخضر بلا أي تعديل عليهما) · contrast matrix ✓ كل البوابات خضراء · stale-refs ✓ · ui-wiring ✓ · next build: التجميع ✓ Compiled successfully لكن مرحلة TS داخل البناء قُتلت OOM بذاكرة الـsandbox (4GB لمشروع 2020 مسارًا — tsc المستقل 0 والبطارية الرسمية للـCI خضراء؛ البناء الكامل يكتمل عند Vercel) · التحقق الحي محليًا: EN/AR × Light/Dark × Desktop/Mobile بلا overflow أفقي، المسار الذهبي (الحاسبة → 3 أشرطة ماكروز، زر Continue → ودجت EVO يُحمَّل بالمحتوى، الكاروسيل يمرر على الجوال 0→300px)، صفر أخطاء console/hydration، جولة VLM بعد/قبل: «CTA أكثر قابلية للنقر، هرمية العضويات أوضح جذريًا، شكل عالمي أكثر فخامة دون سؤال».
- (إصلاح بوابة parity بعد الدفعة الأولى) ترويسة DESIGN.md «Last updated» وصفا السجل (DESIGN.md وdocs/README.md نفسه) كانا 2026-09-24 بينما آخر كوميت صار 2026-09-25 — فحص I/M (صدق التواريخ) فشل بCI؛ حُدّثت الثلاثة إلى 2026-09-25 بنفس فريم الإصلاح والبوابة خضراء محليًا.
- (مصادر المكونات — 21st.dev) اعتُمد مبدأ تفضيل المكونات القائمة: الرقائق/اللوحة/السكة تركيب مباشر من وصفات النظام الحالية (ThemeImg/EngravedIcon/marble-card/recipes) — صفر اعتماديات جديدة وصفر تبعية خارجية، حفاظًا على وحدة المنتج وقوانين RTL/الثيم/الأداء.

Stage Summary:
- موجة VRD-V6 منفذة: ثلاثية المنصة بالهيرو + إحساس معدني للأزرار + EVO كسطح منتج + سكة ماكروز للأنظمة الغذائية + هرمية عضويات أحادية المرساة + مرآتا التوكنز والتوثيق — الهوية طُوّرت ولم تُستبدل، وصفر مساس بأي منطق أعمال/مسارات/API/بيانات.
- Commit SHA: 5900542e
- Push status: pushed (adb1f65c..5900542e على origin/main)

---
Task ID: DOC-REMEDIATION-274-2026-09-24
Agent: Super Z (owner session)
Task: تنفيذ خطة إصلاح منظومة التوثيق المعتمدة P0→P3 كاملة + تحصين البوابات (أمر المالك 2026-09-24: اعتماد تقرير Alkemos-Documentation-Audit-Report-2026-09-24 وتنفيذه، وتحويل المستودع PRIVATE، ثم Commit + Push — بلا أي مساس بBusiness Logic/API/Database/UI/Secrets).

Work Log:
- (P0 — م-01/ت-1) المستودع تحول PRIVATE عبر GitHub API (كان عامًا فعليًا: private=False قبل التنفيذ؛ فُحص كذلك مستودع النسخ musclehubeg-backups فكان خاصًا أصلًا) — تحقق القبول: git ls-remote مجهول يُرفض (exit 128) · API المجهول محجوب · صلاحيات admin مؤكدة على الريبوين.
- (P1 — ت-3..ت-6) DEVELOPER_GUIDE: جدول العضويات §5 → إحالة memberships.ts/tier-limits.ts · جدولا الاعتماديات §9 حُذفا → إحالة package.json/bun.lock (كانا يذكران framer-motion وz-ai-web-dev-sdk المحذوفتين) · أرقام الاختبارات §11 حُذفت → STATE.md · قسم الألوان §12 والـPALETTE الثابتة → إحالة DESIGN.md (Marble & Chrome برموز globals.css) · دوال AI والمزودون §12 → مطابقة AGENTS §8 (ثلاثي المزودين؛ callFreeAIFallbackChain للمحادثة وcallFreeOpenRouterRace للتبديلات فقط) · شجرة §2 أعيد رسمها بمجموعات المسارات الأربع ((en)/(ar)/(app)/api) · ترويسة 7 عناصر موحدة.
- (P1 — ت-7..ت-10) بريد الديمو وُحّد على ahmed@coach.app في README/DEVELOPER_GUIDE/SECURITY/.env.example (المصدر: بذر auth.ts) · جدول كاش SECURITY §10 أعيد اشتقاقه من vercel.json (عائلات الصور: /images/* 24س · exercises/* سنة immutable · brand/* 300s+SWR · sw.js دائمًا revalidate) · is_coach §11 صُححت لنموذج الأدوار v2 (role IN ('coach','admin') — ميجريشن 0029) بإحالة TECH_REFERENCE §2.2 · CI_GATES استكمل جدول workflows بالأربعة الغائبة (external-mirror/storage-backup/storage-inventory/storage-restore-drill) وصُحح تواتر تنقية Vercel (كل ساعة لا مرتين يوميًا) · metadata.json صارت ثلاثية المزودين · LICENSE (رابط المستودع الحالي + §2 RESTRICTED ACCESS بدل PUBLIC REPOSITORY) · عنوان INDEX.md → Alkemos.
- (P2 — ت-11..ت-13) سجل docs/README.md: كل صفوف Last-updated أعيد اشتقاقها مقابل git (12 صفًا صُححت منها 5 انجرافات إضافية لم يرصدها التقرير: CONTRIBUTING/TECH_REFERENCE/DEEP-AUDIT-PLAN/VERCEL-USAGE-AUDIT/DESIGN) + صف VISUAL-REDESIGN: V4-V5 منفذتان (265/267) والبرنامج مكتمل · engines أُضيف بpackage.json (node >=20.9.0) مع تحديث متطلب Node بالتوثيقين (كان 18+).
- (P2 — ت-14 + التحصين) docs_audit.py توسع بتسعة فحوص مضادة للانجراف: D2 أنماط أرقام موسعة للدليل (اختبارات/جداول اعتماديات/قيم ألوان سداسية) · H4 Task IDs مؤرخة إلزاميًا (سد فجوة الإلحق بأسفل worklog التي هربت بها المدخل 273) · L بريد الديمو = بذر auth.ts · M سجل docs/README مفروض آليًا (المسارات موجودة + التاريخ لا يتخلف عن git مع إعفاء STATE/worklog بسابقة فحص I) · N تغطية CI_GATES لكل ملف workflow · P متطلب Node لا يقل عن engines · Q ذكر «OpenRouter + Groq» يستلزم NVIDIA · R مسارات backtick بالوثائق الحاكمة الخمس يجب أن توجد (بقوائم سماح موثقة للمتقاعد/المولّد) · T أوامر run الموثقة scripts حقيقية — كلها عبر docs-parity-gate القائم بلا workflow جديد.
- (P3 — ت-15..ت-16) docs/_AUDIT.md وdocs/_NAV_MAP.md رُحّلا إلى docs/archive/ (git mv) مع تحديث إحالة AGENTS §12.5.2 وصفوف السجل · إصلاح موضع مدخل HOME-PARITY-273 (كان مُلحقًا بأسفل worklog بلا تاريخ — خالف newest-on-top وهرب من بوابة H) — نُقل للقمة ومؤرَّخ.
- (اكتشافات إضافية أثناء التنفيذ خارج نطاق التقرير) ثلاثة مسارات ميتة بSECURITY أُصلحت: RUN_ON_SUPABASE.sql (موقعه archive/ لا supabase/migrations/ ×2) وسكربت consent-mode-v2 (موقعه src/components/root-shell.tsx لا src/app/layout.tsx) · مدخل 273 المذكور أعلاه.
- (التحقق) البوابات الخمس على الحالة النهائية: docs_audit (بالفحوص التسعة الجديدة) ✓ · docs_parity ✓ · stale-refs ✓ · ui-wiring ✓ · migration_audit --ci ✓ (صفر انجراف جديد) · فحص أسرار على الفروق = صفر · نطاق الفروق توثيقي صرف (الاستثناء الوحيد: حقل engines بpackage.json — ضمن ت-13 المعتمدة) · STATE.md = 97 سطرًا/31,950 بايت تحت السقف.
- (بلا مساس) صفر تغيير على src/ أو supabase/migrations/ أو UI أو أي سر — المنع الملكي ملزم.
...
Agent: Super Z (main)
Task: قانون مطابقة أدوات الرئيسية بالأدوات الأصلية (أمر المالك 2026-09-24 «تاكد ان الادوات على الرئيسية تطابق الادوات الاصلية من كل شىء مثل الخانات المطلوبة وباقى التفاصيل للتوليد — مثلا أداة توليد خطة غذائية على الرئيسية لا يوجد بها تحديد سعرات او باقى تفاصيل الأداة الاصلية»).

Work Log:
- تدقيق مطابقة كامل: HomeCalculator = /tools/calorie-calculator بالحقول الستة والمعادلات نفسها (مطابقة أصلًا) · #eat/#library مستعرضان لا أدوات توليد · الفجوة الحقيقية ببطاقتي #plan:
  - التغذية: رقائق سعرات مقيدة (6 مستويات ≤3000) مقابل حقل الأداة الأصلية الحر (رقمي 1200–4000) + خانة «ملاحظات اختيارية» غائبة.
  - التمارين: هدف/مستوى/أيام/معدات بنفس مصدر المفردات (مطابقة) + الملاحظات غائبة.
- MealPlanBuilder: رقائق السعرات استُبدلت بحقل الأداة نفسه — label «سعرات اليوم المستهدفة/Daily calorie target» + input رقمي (min 1200 · max 4000 · step 50 · dir=ltr) + تلميح الأداة «من 1200 إلى 4000 — لا تعرف رقمك؟ حاسبة السعرات» برابط لصفحة الحاسبة (نفس هدف رابط الأداة) · الحالة صارت نصية «2000» مثل الأداة تمامًا (Number() عند الجلب/الحفظ) · زر التوليد يعطَّل عند الفراغ (disabled={loading || !calories}) · سطر المعاينة يشتق بـ Number(calories || 0).
- خانة الملاحظات (≤200 حرفًا، maxLength={200}) بكلتا البطاقتين بنفس نص الأداة: التغذية «ملاحظات اختيارية/Optional preferences» بمثل «بلا منتجات الألبان، سمك مرتين أسبوعياً…» والتمارين «ملاحظات اختيارية/Optional constraints» بمثل «أتجنب الضغط على الركبة اليسرى…» — وتغيير أي خانة يعيد البطاقة للمعاينة الحية (قانون 271).
- الطلب والمظروف: notes: notes || undefined في جسم fetch الأداتين + الملاحظات داخل inputs بsaveGuestPlan للنوعين — فتستعيدها صفحتا الأداة الكاملة حرفيًا (setNotes من inputs.notes).
- كاناري homepage-adoption: تثبيت قانون المطابقة (min={1200} · max={4000} · maxLength={200} ×2 · notes ×2 · نصّا المظروفين) + حظر سجل الرقائق المحذوف (pickCalories(lv)) + تحديث وصف البند 4.
- STATE.md: مدخل (٠٠) 273 + مدخل QA 273 + تصحيح علامة على F3/271 (صحّحه 273: حقل حر 1200→4000 + ملاحظات) + ضغط مدخلات VRD-V1→V3 التاريخية بصف واحد للبقاء تحت السقف (31,868→30,254 بايت — تفاصيلها الكاملة بمدخلاتها الأصلية).
- البوابات: tsc 0 · eslint 0 · vitest 100/1702 · build 2020/2020 · docs_audit ✓ (phase=273) · docs_parity ✓ · stale-refs ✓ · ui-wiring ✓.
- التحقق الحي على dev (agent-browser): AR+EN × 1440/390 — إدخال 3500 سعرة (فوق سقف الرقائق القديم) + ملاحظات «بلا منتجات الألبان، سمك مرتين أسبوعياً» → جسم الطلب يحمل {calories:3500, system, notes, guestId} → الخطة تُصيَّر داخل البطاقة → المظروف alkemos:plan:v1:nutrition يحفظ inputs بالسعرات والملاحظات → «افتح الأداة الكاملة» يفتح /ar/ai-meal-planner بالخطة ظاهرة وكل حقول النموذج مستعادة (3500 + الملاحظات + النظام)؛ ومثلها للتمارين (notes «أتجنب الضغط على الركبة اليسرى» بالطلب والمظروف والأداة) — صفر تجاوز أفقي عند 390px والحقول 316px ظاهرة (بمحاكاة استجابة 200 — بيئة التطوير ترفض شكل الموديل المجاني 422 بالتصميم، والفشل لا يُحسب من الرصيد).

Stage Summary:
- بطاقتا #plan تحملان الآن كل خانات التوليد التي تحملها الأداتان الأصليتان: سعرات حرة 1200–4000 + نظام/هدف/مستوى/أيام/معدات + ملاحظات اختيارية — توليد الرئيسية = توليد الأداة نفسه حرفيًا، والانتقال يحمل كل شيء.
- حاسبة الرئيسية كانت مطابقة أصلًا (نفس الحقول الستة ونفس وحدة fitness-math) — لا فجوات متبقية.
- الحقول الجديدة محموبة بالكاناري (اختبار المطابقة) وبقانون تغيير أي اختيار يعيد المعاينة.
- Commit SHA: 713b6b4e
- Push status: pushed (60de7741..713b6b4e على origin/main)
- **التحقق الحي بعد الدفع (713b6b4e):** الإنتاج alkemos.com على 713b6b4e (build-info · checkedAt 2026-09-24T03:26:25Z) — الحقول الجديدة مؤكدة حية بالعربية (home-meal-calories/notes + workout-notes + «سعرات اليوم المستهدفة» + «من 1200 إلى 4000») والإنجليزية (Daily calorie target + Optional preferences/constraints + From 1200 to 4000).
---
Task ID: HOME-HANDOFF-272-2026-09-24
Agent: Super Z (owner session)
Task: متابعة المالك الثنائية بعد HOME-REFINE-271 (أمر المالك 2026-09-24: «يوجد زر فى التمارين الجاهزة (لإنشاء خطة بالذكاء الاصطناعي) امسحه ، بعد الضغط على زر افتح الأداة الكاملة للحفظ والتصدير الخطة المولده لا تظهر فى صفحة الأداة»).

Work Log:
- (1) قسم #train (برامج التمارين الجاهزة): حُذف زر «ابنِ خطتك بالذكاء الاصطناعي / Build your plan with AI» كليًا — قسم البرامج صار بـCTA وحيد «كل البرامج / All programs» مُرقّى لوصفة أقسام التصفح الموحدة (btn-outline px-7 py-3 مثل #library/#eat/#diet) — إنشاء الخطط بالذكاء الاصطناعي أصبح ملك #plan وحده (باني التمارين) فلا ازدواجية عرض.
- (2) قانون انتقال الخطة (THE HAND-OFF LAW — جذر العلة): بانيا الرئيسية كانا يستدعيان نقاط التوليد ولا يحفظان شيئًا — صفحتا الأداة الكاملة تستعيدان الخطة من localStorage (زائر) أو من الحساب (عضو) فلا تجدان شيئًا. الإصلاح المزدوج:
  - LandingView.tsx — WorkoutPlanBuilder وMealPlanBuilder يحفظان كل توليد ناجح فورًا بsaveGuestPlan (نفس مظروف plan-persistence v1) ومعه inputs الاختيارات ({goal,level,days,equipment} و{calories,system}) — فلينك «افتح الأداة الكاملة للحفظ والتصدير» يفتح الأداة وخطة الزائر ظاهرة بها فعليًا (زائر: النسخة المحلية فورًا؛ عضو: الحفظ التلقائي للحساب من المسار نفسه + المرآة المحلية ككاش).
  - صفحتا الأداة الكاملة (ai-workout-planner/ai-meal-planner): الـfallback المحلي صار أرضية لأي زائر — علم restored يحل محل شرط !profile القديم، فالعضو الذي لا ترجع له نسخة حساب (fetch فاشل/فارغ) يسقط على المرآة المحلية بدل صفحة فارغة (الخطة المولدة بالرئيسية لا تصل أبدًا لأداة فارغة).
- الكاناري homepage-adoption.test.ts أُعيد تثبيته: نصّا الزر المحذوف نقلا لقائمة الحظر (retired block strings) · تثبيت استيراد saveGuestPlan + استدعاءَيه (workout/nutrition ×1 لكل) · O-3 حُدّث (زر px-6 py-2.5 الهادئ ≥1 للمدونة + وصفة CTA الموحدة ≥4 لأقسام التصفح الأربعة) · ترويسة الملف وثّقت إطار 272.
- البوابات: tsc 0 · eslint 0 · vitest 100/**1702** · build 2020/2020 · docs_audit ✓ (STATE 31,868B تحت السقف) · docs_parity ✓ · stale-refs ✓.
- التحقق الحي (next dev + agent-browser بمحاكاة استجابة 200 للمسارَين — بيئة التطوير ترفض شكل الموديل المجاني 422): AR ديسكتوب 1440 — #train بلا زر الذكاء و«كل البرامج» وحيد (روابط القسم: 3 برامج + CTA واحد) · توليد خطة تمارين بالرئيسية: البطاقة تصيّر الأسبوع + «رصيد الشهر» + **كتابة alkemos:plan:v1:workout في localStorage** (kind/inputs صحيحان) → «افتح الأداة الكاملة» → /ar/ai-workout-planner يعرض «نظامك المولّد لهذا الأسبوع» بأيامه الثلاثة وحركاته (اليوم 1/بنش برس/سكوات) · توليد خطة تغذية: اليوم يُصيَّر + alkemos:plan:v1:nutrition (kcal 2000) → /ar/ai-meal-planner يعرض الوجبات الأربع والصنف والإجمالي · الخطة تنجو من reload · AR جوال 390: القسم سليم بلا overflow أفقي · EN: الزر المحذوف غائب وAll programs وحيد · VLM على اللقطات: قسم البرامج بلا كسر بصري والأداة تعرض الخطة المولدة كاملة.

Stage Summary:
- زر الذكاء في «برامج التمارين الجاهزة» مُحذوف (AR/EN، ديسكتوب/جوال) و«كل البرامج» هو CTA القسم الوحيد بوصفة الأقسام الموحدة.
- الثنائية (توليد بالرئيسية → فتح الأداة الكاملة) تعمل فعلًا الآن للأداتين معًا: الخطة تُحفظ بنفس مظروف الأدوات وتظهر داخلها (مع الاختيارات نفسها) — والأدوات لا تصل أبدًا لصفحة فارغة طالما وُجدت مرآة محلية.
- قوانين الصدق محفوظة: الفشل لا يُحسب من الرصيد والخطة تبقى معروضة بعد نفاد البول.
- Commit SHA: 44cfcb3e
- Push status: pushed (765dc456..44cfcb3e على origin/main — Vercel auto-deploy)
---
Task ID: HOME-REFINE-270-2026-09-24
Agent: Super Z (owner session)
Task: تعديلات المالك التسعة على الرئيسية بعد HOME-EXPERIENCE-269 (أمر المالك 2026-09-24 «التعديلات المطلوبة» — تسعة بنود نصية).

Work Log:
- B1 الهيرو: زران فقط جنبًا لجنب — «تسجيل الدخول / حساب جديد» (/auth?mode=signup، أساسي) + «العضويات المميزة» (/memberships، outline)؛ العضو المسجل يرى لوحة التحكم + العضويات؛ حُذف زر #start ورابط الدخول الهادئ (قانون 203 المسرح الحالي تعديله صريح بأمر المالك — الكاناري أعيد تثبيته للقانون الجديد).
- B2 شريط الأرقام: صف واحد مضغوط (py-3.5، أرقام chrome text-base/lg + تسميات سطرية text-xs/sm، بلا أيقونات) — الأرقام الأربعة الموثقة نفسها (868+/8,830+/8/10) والعد التصاعدي + fallback SSR محفوظان.
- B3 إلغاء غلاف «تجربة حية — دون تسجيل» بالكامل (العنوان + التبويبات الثلاثة + المقدمة) — الأسطح الثلاثة صارت أقسامًا مستقلة بعناوينها: #start الحاسبة · #evo لـEVO وحده (ورث فن المحارب والبطاقة الرخامية من القسم القديم + EvoConversation: المحادثة الموسومة + زر الودجت + حصة الزوار 10 رسائل + رابط /evo) · مكتبة التمارين انتقلت لكوراسول (B4).
- B4 مكتبة التمارين كوراسول مثل المدونة (16 عينة LandingExerciseCard بعرض ثابت داخل CarouselShell مشترك استُخرج من BlogCarousel — نفس وصفتي الأسهم RTL-آمنة 44px) ونُقلت قبل المدونة مباشرة + قسم جديد «مكتبة الخطط الغذائية الجاهزة» كوراسول (4 كروت أنظمة، كل كارت → /diet-plan/2000/{system} ورقة حقيقية، CTA للهاب) — البيانات عبر شريحة خادم جديدة home-samples.dietSystems (+dietLevels) مشتقة من DIET_SYSTEMS (single source، بندل القانون محفوظ).
- B5 القسم القديم «التخطيط الذكي و EVO» حُذف بالكامل (العنوان المختلط + الخطوات 01-03 + سطر الحصص المختلط + إيحاء المدرب) — الجديد #plan «التخطيط الذكي» تفاعلي مثل الأدوات: بطاقتان — باني خطة التمارين (الهدف/المستوى/الأيام 2-6/المعدات بمفردات المخطط الحقيقي المستوردة من ai-workout-planner.ts + معاينة حية لهيكل الأسبوع WORKOUT_SPLITS + CTA «أنشئ خطة التمارين») وباني خطة التغذية (الهدف + النظام من شريحة الأنظمة + أشرطة ماكروز حقيقية + اتجاه السعرات −20/0/+10 المطابق لـplan-generator + ربط بالحاسبة أعلاه + CTA «أنشئ خطتي/Create My Plan» المثبت) — صفر ذكر لـEVO وصفر «مدرب/coach» داخل القسم (كاناري بفحص المنطقة src.slice).
- B6 المدونة: العنوان «أحدث المقالات/Latest Articles» بلا شرح طويل + الكوراسول الأحدث أولًا فعلًا ([...latestPosts, ...featuredPosts] بدل العكس).
- B7 قسم التسعير الكبير أُلغي (السلم + الثلاث بطاقات الكبيرة) — البديل: 3 كروت صغيرة (مجاني→تسجيل، بريميوم ب«موصى بها» دارك ماربل + حلقة كروم، برو) + كارت التدريب الأونلاين الأفقي الداكن بالزر الممتلأ الوحيد (O-3) + سطر استرداد 7 أيام — كل الأسعار مشتقة (premiumPriceLabel/proPriceLabel/coachingPriceLabel/freePriceLabel من memberships.find).
- B8 قسم CTA الختامي («ابدأ اليوم…» + باب EVO) أُلغي — الصفحة تنتهي بالـFAQ.
- B9 الفوتر: أُلغيت مجموعتا <details> كاملتين والنسخ المكررة — شبكة مسطحة واحدة 2/3/6 أعمدة (brand col-span ثم الأعمدة الخمسة) بكل الروابط ظاهرة دائمًا وكل href مرة واحدة (قانون المزامنة صار ×1) + حذف ChevronDown و.footer-disc.
- CSS: حذف الوصفات الميتة في نفس الفريم (.home-tabs/.home-tab · .chips-row · .footer-disc) — MUSCLE_TABS وLibraryBrowser وstartTab حُذفوا.
- الكاناري: homepage-adoption.test.ts أُعيد تثبيته كاملًا لقوانين 270 (27 اختبارًا: الهيرو بزريّه · الشريط المضغوط · الرياضيات أحادية المصدر · EVO مستقل بالقوانين · #plan نظيف بفحص المنطقة · خريطة الأقسام والترتيب الجديد · الفوتر المسطح ×1 · O-3 الجديد · card-lift ×8 · الحركة بدون .home-tabs · K-1=2) + استعادة قانون كروت الطعام VRD-V3 + ai-meal-planner حُدّث تثبيته (id=plan + الزوج المثبت + حظر العنوان القديم).
- البوابات: tsc 0 · eslint 0 (تحذير root-shell القديم وحده) · vitest 100/1702 · build 2020/2020 · docs_audit ✓ (STATE ضُغط ليدخل سقف 32KB).
- التحقق الحي المحلي (next dev + agent-browser): EN/AR × 1440/390 — الهيرو بزريّن صحيحين بالعربية والإنجليزية · الشريط صف واحد (ارتفاع 84px على الجوال) بلا overflow أفقي في أي سياق · الحاسبة 2,802 سعرة/210ب/280ك/93د للحالة المعتمدة (مطابقة للـ269) · باني التمارين: endurance + 5 أيام = «Push/Pull/Legs + Upper/Lower» بأيام صحيحة · باني التغذية: كيتو = 25/5/70 والهدف −20% تحت الصيانة · كوراسولا التمارين (16 بطاقة) والأنظمة الأربعة قبل المدونة · كروت العضويات الأربعة + الاسترداد + زر الكوتشينج · لا CTA ختامي (آخر H2 = FAQ) · الفوتر مسطح 33 رابطًا على الرئيسية والمدونة وكل المقاسات · RTL سليم — قسم المدونة لا يُصيَّر محليًا لغياب مفاتيح Supabase ببيئة التطوير (قانون needsPosts العمد؛ منطق الترتيب مغطى بالكاناري والمسار مُوثق حيًا في 269).

Stage Summary:
- الرئيسية صارت بالبنية التي رسمها المالك حرفيًا: زرّا هيرو · شريط أرقام واحد · ثلاثة أقسام تفاعلية مستقلة (حاسبة/EVO/تخطيط ذكي ببانيْين) · كوراسولا المكتبتين قبل المدونة · مدونة «أحدث المقالات» بأحدث فعلًا · كروت عضويات صغيرة + كارت تدريب أونلاين · بلا CTA ختامي · فوتر مسطح معروض بالكامل.
- القوانين المحفوظة: مصدر الرياضيات الوحيد · وسم النموذج التوضيحي وقانون سطح المحادثة (الودجت وحده) · الأسعار من memberships.ts فقط · EN/AR زوجان أصيلان · الأرقام من الثوابت الموثقة · الحركة مرة واحدة وخلف reduced-motion · الصدق في المعاينات (تقول إن الخطة الكاملة تُبنى بالأداة).
- الأصول: LandingView.tsx (أعيدت هيكلته) · SiteFooter.tsx (مسطح) · home-samples.ts (+dietSystems) · globals.css (−3 وصفات ميتة) · homepage-adoption.test.ts (27) · ai-meal-planner.test.ts · README/STATE محدثان.
...
Work Log:
- النشر مؤكد فور اكتمال بناء Vercel (تخطي كاش Cloudflare بمعامل cb): كل نصوص V4 حية بالـHTML بعمر 0
- CI على 63c5bc24: **4/4 خضراء** (Quality gate · Docs & schema parity · Anti-regression guard · Vercel cleanup)
- الإنتاج EN: بطل K-6 الجديد حي والقديم ميت (0) · تعداد K-7 الثلاثي حي و«bigger save capacity» ميت (0)
- الإنتاج AR: البطل K-6 حي · K-1 ×3 (FAQ×2 عبر JSON-LD + البطاقة) · K-4 الفوتر · K-3 النشرة · رقاقة «كور» — وكل النصوص القديمة ميتة (توليدات/صُنع بحب/على المنصة/اشترك الآن = 0)
- بطاقتا «بطن/كور» الباقيتان هما تسميتا فئة عينات التمارين (بلانك) من مصدر مكتبة التمارين — خارج نطاق K-5 الموثق (§19 يحدده برقاقة القسم وحدها)
- شريط المدربين K-2: `/api/coaches/featured` يعيد `{"coaches":[]}` — لا إعلانات مدفوعة نشطة الآن (حالة بيانات لا انحدار؛ الشريط لا يرندر بلا إعلانات بحسب التصميم) — الرندر أُثبت بمحاكاة الـAPI محليًا: H2 «مدربون مميزون على Alkemos» + لقطة أرشيفية v4-ar-coaches-H2-mocked.png
- الجوال الحي 390×844: AR ‏**10,037px** (كانت 10,046 بـV3 — أخف بـ9px من القصوص) · EN ‏**10,274px** (كما هي — الأقسام المؤجلة هي الحاملة) · **صفر overflow أفقي** بالغتين
- لقطات الإنتاج download/v4-shots/ (11: 9 محلية + H2-المحاكاة + بطل EN-الحي)

Stage Summary:
- V4 حية على الإنتاج ومطابقة للتحقق المحلي — الموجة التالية V5 (مسح + DESIGN.md + C-18) بأمر المالك
- Commit SHA: 63c5bc24
- Push status: pushed (الكوميت التوثيقي هذا يحمل المدخل)

---
Task ID: VRD-V4-2026-09-23
Agent: Super Z (owner session)
Task: تنفيذ Wave V4 «النصوص» (أمر المالك «اكمل V4 الآن… ابدأ مباشرة من K-1..K-7، دون إعادة كتابة البنود السابقة») — بنود §14 الجراحية + مهمة tailwind بـ§19، بلا O-1b (لم يُطلب).

Work Log:
- قراءة النطاق: §14 (K-1..K-7) + §19 (ملفات V4 + مهمة tailwind الشرطية + إعادة تثبيت الكناريات بنفس الفريم) + §20 (معايير خروج V4: JSON-LD أحادي · og بلا تغيير · MSA نظيف) + §23.9 (ممنوع إعادة كتابة النصوص)
- K-1 — «توليدات خطط أكثر» ← «توليد خطط أكثر» ×3 (FAQ ‏277/281 + بطاقة العضويات 829): الجمع الآلي المزيف مات في الرئيسية؛ العدادات الرقمية («4/8 توليدات شهريًا») في memberships.ts صفحة الأسعار خارج النطاق عمدًا (§19)
- K-2 — H2 المدربين «مدربون على المنصة» ← «مدربون مميزون على Alkemos» (استعادة معنى Featured المطابق للإنجليزية C-17)
- K-3 — زر النشرة «اشترك الآن مجانًا» ← «اشترك مجانًا» (إسقاط «الآن» التسويقية التي تتجنبها الإنجليزية)
- K-4 — سطر الفوتر «صُنع بحب لمجتمع اللياقة» ← «صُنع بعناية لمجتمع اللياقة» (مرآة "care" الإنجليزية) + تحديث التعليقين التوثيقيين بالمكوّن
- K-5 — رقاقة العضلات «بطن/كور» ← «كور» المجردة (سجل بايسبس/ترايسبس المعرّبة)؛ تسميات مكتبة التمارين تبقى «بطن/كور» — §19 يحدد K-5 برقاقة الرئيسية حصرًا + تحديث تعليق globals.css الموثق لقياس V3
- K-6 — زوج البطل مقصوص ~25% حرفيًا من التدقيق: EN ‏«Training, nutrition, and smart tools — one plan that moves with you toward your goal.» · AR «تدريب وتغذية وأدوات ذكية — خطة واحدة تقترب بك من هدفك.» (يخفف C-9)
- K-7 — تعداد بطاقة العضويات 4←3 بندين: EN أسقط «bigger save capacity with export» (33←27 كلمة) وAR أسقط «حفظ وتصدير أوسع»؛ الثلاثي الأساسي EN حرفي؛ بطاقة الكوتشينج لم تُمس (25/17 كلمة تحت الحد أصلًا)
- §19 tailwind — ظلا boxShadow النيلي glow والكهرماني gold أُزيلا من tailwind.config.ts بعد تحقق grep: الملف ميت بنيويًا (Tailwind v4 CSS-first بلا @config أيًا كان + components.json يشير لglobals.css) والأدوات الحية shadow-glow/gold/card من @utility بglobals.css فوق توكنز رتيبة — إزالة الملف كاملًا مؤجلة لـV5/C-18 (موثقة بتعليق بالملف)
- الكناريات (قانون §21.3 نفس الفريم): +8 اختبارات V4 بhomepage-adoption (K-1 عدّ 3× + حظر «توليدات» بالكامل · K-2 · K-5 · K-3 على NewsletterForm · K-4 على SiteFooter مع حظر القديم · K-6 حظر الزوج المتقاعد · K-7 · JSON-LD أحادي المصدر: تثبيت getFAQSchema(faqs) وحظر «"@type"»/«"Question"» داخل العرض) + إعادة تثبيت زوج البطل (BLUEPRINT-257) وسطر الفوتر
- البوابات: tsc ✓ 0 · eslint ✓ 0 (تحذير root-shell المسبق وحده) · vitest ✓ 100/1706 · build ✓ 2020/2020 · parity/migration/stale-refs/ui-wiring ✓ · docs_audit ✓ (STATE ‏97 سطرًا/31,165B تحت السقف — دمج صفّي 251+250 لاستيعاب صف 265) · مصفوفة التباين ✓ (صفر تغيير توكنز)
- التحقق الحي محليًا (next start): كل النصوص الجديدة رندر AR/EN · «توليدات» صفر بالصفحة · JSON-LD يحمل صياغة K-1 ×2 (مشتق من نفس المصفوفة) · og:description كما هو · 12 مسارًا 200 · الارتفاعات مستقرة 9,474px EN / 9,257px AR عند 390 (القصوص داخل الأسطر — نفس عدد الأسطر) وصفر overflow أفقي
- ملاحظة رندر FAQ: إجابات الأكورديون (Radix) لا تُرندر SSR للمغلق — سلوك مسبق منذ 257؛ الـJSON-LD يحملها لـSEO والرندر التفاعلي من نفس المصفوفة (النص الجديد مؤكد بحزمة JS)
- VLM (§21.4): بطل AR فاتح (سطران نظيفان عند الشرطة) · بطل EN فاتح · بطل AR داكن · رقائق صف واحد والرقاقة الأخيرة كلمة واحدة · عضويات 3 أسطر مقصوصة بتوازن · فوتر نظيف — كلها PASS؛ قراءة VLM الخاطئة لزر النشرة الصغير («اشترك الآن») دُحضت بـDOM حي: «اشترك مجانًا» · لقطات download/v4-shots/ (9) — لقطتا الوضع الداكن أعيد التقاطهما بمحدد data-theme الصحيح بعد أن أثبتت الفحوص أن .dark وحده لا يبدّل التوكنز

Stage Summary:
- V4 كاملة كفريم واحد قابل للتراجع: 7 بنود نسخ جراحية + إزالة ظلي النيلي/الكهرماني الميتين + 10 تثبيبات كاناري — بلا أي لون جديد وبلا أي إعادة كتابة وبلا مساس بـmetadata
- Commit SHA: this commit carries this entry
- Push status: pending (يدفع بهذا الفريم — التحقق الحي بمدخل لاحق)
...
Work Log:
- قراءة الخطة: §11 (كثافة البطاقات وhover الموحد) + §13 (معيار الأزرار + primary-per-fold + O-3) + §16 (بطل الجوال C-9 + رقائق C-11 + إيقاع C-10) + §17 (reduced-motion) + §19/§21 (الملفات والبوابات) + §25 (القرارات — O-3 نعم، بلا accent)
- globals.css — أرضية بطل الجوال `max(56vh, 100vw×713/1280)` تحت md فقط (332←473px عند 390×844 — الكسر الجانبي يمتصه cover والشريط المحوري للبار/الأعمدة يبقى) · معيار الأزرار §13.2 بوصفات min-height: أساسي 48 لمس/52 من md+ · ثانوي 44/48 (الحشوات تغذي الأرضية فقط) · `.chips-row`: صف واحد nowrap + scroll-snap-type: x proximity + أقنعة تلاشي متناظرة 24px (RTL-آمنة) على الحاوية نفسها + منع انكماش/كسر الرقائق (قياس أول كشف رقاقة «بطن/كور» تنكسر داخليًا لسطرين 47px — أصلحت بـflex-shrink:0 + white-space:nowrap) · `.marble-card.card-lift`: hover موحد 2px + --shadow-lift (توكن جديد بالوضعين) + حافة color-mix(--text 22%) بديل --accent-deep الميت (رفض البرونز §25) + `transform:none` تحت reduced-motion · إيقاع الجوال: كل المقاطع py-12←py-10 والفرجات mt-10←mt-8 تحت md (md+ بلا تغيير)
- LandingView.tsx — البطل: تكديس CTA الثلاثة بعرض كامل تحت md (أساسي←ثانوي←Log in هادئ مركزي بخلوص مقيس 28px) والديسكتوب صف واحد بفجوة 20px مقيسة · المسارات: أيقونة+عنوان صفًا واحدًا + وصف مقصوص سطرين + p-5 (الكتلة 818←547px) · الخطة/العضويات/EVO ‏p-5 جوال + نسخ العضويات مقصوصة 3 أسطر · الطعام: أرضية عنوان min-h-10 لمحاذاة صفوف الماكروز + إيقاع gap-2 (إزالة الفراغ الميت C-1-VLM) · **O-3**: بطاقة الباقات `.btn-chrome` والكوتشينج يبقى outline (قانون primary-per-fold اكتمل: بطل/خطة/EVO/ختام + عضويات) · card-lift على العائلات التفاعلية الست (مسارات/تمارين/أطعمة/برامج/مدونة/مدربون) — الأدوات القديمة hover:-translate-y-0.5 بقيت على seal-chip وحدها
- الكاناريات: +7 اختبارات V3 بhomepage-adoption (البطل/الرقائق/الكثافة/الطعام/المعيار/O-3/hover) · كاناري لمس V0 أعيد تثبيته بنفس الفريم للمعيار الأعلى (44←48/52 — §21.3) · توحيد حشوات أزرار البطل/الختام لتطابق المعيار بالضبط (ديسكتوب 54/50←52/48)
- البوابات: tsc ✓ 0 · eslint ✓ 0 (تحذير root-shell وحده) · vitest ✓ 100/1698 · build ✓ 2020/2020 · تباين ✓ كل البوابات · parity/migration/stale-refs/ui-wiring ✓ · docs_audit ✓ (STATE ضُغط للسقف 31.4KB/97 سطرًا — صفوف 234-237 و238-239 مُدمجة وتفاصيلها بworklog)
- القياس الحي محليًا (next start + رأسي): **النواة الساكنة (بلا أقسام ديناميكية) 9,474px EN / 9,257px AR عند 390px** مقابل أساس ما قبل V3 بنفس الشرط 9,961/9,561 (قياس أمين: git stash ← build ← قياس ← pop) — بوابة ≤9,500 تتحقق للصفحة الساكنة؛ الصفحة الحية تحمل إضافيًا كاروسيل LEARN المؤجل + شريط المدربين المدفوع (~1,200px حاملة محتوى خارج مساس V3 بقانوني §11 «بطاقات التمارين بلا تغيير» وصفر حذف محتوى) · صفر overflow أفقي في **16 سياقًا** (390/768/1024/1440 × EN/AR × فاتح/داكن) · جدول CTA مطابق حرفيًا: جوال أساسي 48/ثانوي 44 · ديسكتوب 52/48 · فوتر/أسهم 44 · الرقائق صف واحد tops متطابقة وقابلية تمرير مؤكدة
- VLM (بروتوكول §21.4): EN فاتح/داكن ديسكتوب PASS (ملاحظة VLM وحيدة عن «تقارب Log in» دُحضت بقياس DOM: فجوة 20px محاذاة مركزية) · AR فاتح/داكن ديسكتوب PASS (كايرو سليم RTL سليم) · جوال EN بطل+مسارات PASS · جوال AR داكن بطل+تدريب PASS · لقطة موجّهة لعدم التماثل O-3 ‏PASS — اللقطات download/v3-shots/ (10)
- ملاحظة منهجية: قسم LEARN لا يرندر محليًا (بلا قاعدة بيانات) — قياسات الأساس وما بعده أُخذت بنفس الشرط للمقارنة العادلة، والتحقق النهائي للصفحة الكاملة على الإنتاج بعد النشر
...
Agent: Super Z (owner session)
Task: التحقق الحي بعد النشر — Wave V2 على إنتاج alkemos.com (الكوميت c92330fb) — إغلاق واجب الإطار السابق.

Work Log:
- النشر مؤكد بتخطي كاش Cloudflare (معامل cb): HTML يحمل أكورديوني `.footer-disc group` اثنين + summaries ‏min-h-11 (صفوف 44px)
- CSS الإنتاج يحمل كل وصفات V2: `.footer-disc summary` (إخفاء marker) + زجاج الكوكيز `color-mix(in srgb, var(--card) 92%, transparent)` + `backdrop-filter:blur(16px)saturate(1.05)`
- قياس رأسي مباشر 390×844 AR: **فوتر الجوال 668px محسوبًا** (مطابق للقياس المحلي حرفيًا) + صفر overflow أفقي
- px-3.5 حي بعناصر تنقل الهيدر (HTML) — لقطتان أرشيفيتان download/v2-shots-prod/
- CI على c92330fb: كل الـworkflows خضراء (quality/anti-regression/cleanup + backup completed)

Stage Summary:
- V2 مغلقة على الإنتاج بالكامل — الفريم التالي V3 بأمر المالك
- Commit SHA: c92330fb
- Push status: pushed

---
Task ID: VRD-V2-2026-09-23
Agent: Super Z (owner session)
Task: تنفيذ Wave V2 «الأسطح والهيكل» (أمر المالك «اكمل المرحلة التالية» + توكن دفع) — إعادة بناء الفوتر §12/C-8 + تباعد الهيدر §12 + زجاج الكوكيز S-5/C-16، مع بقاء الميندر بقرار المالك.

Work Log:
- قراءة الخطة: §20 (نطاق V2) + §12 (الفوتر/الهيدر) + §9.2 (الميندر — الإزالة المكتوبة فيها ملغاة بسجل §25: «Meander dividers STAY — light Greek identity kept») + §5/§17 (زجاج الكوكيز ≥4.5:1) — نطاق V1 الموسع كان استوعب وصفة .marble-card مسبقًا فبقي للـV2: الفوتر/الهيدر/الكوكيز فقط
- SiteFooter.tsx: تحت lg تنهار القوائم الخمس في مجموعتي <details> أصليتين («الخدمات/Services» بتفريعاتها الأربع مع ترويساتها الفرعية + «المنصة/Platform» لقائمة Company بلا ترويسة داخلية) — صفوف 44px (min-h-11) صفر-JS مقسمة divide-y + border-y، شيفرون group-open:rotate-180 · فوق lg نسخة الشبكة المسطحة من lg:grid-cols-5 داخل عمود واحد — نمط الهيدر نفسه (desktop nav + drawer) — **رفض متعمد لحيلة force-open بـCSS على <details> المغلق لأنها تُخفي المحتوى من شجرة الوصولية لقارئات الشاشة على الديسكتوب** (sighted يرى وSR لا يصل — تعارض WCAG) · قانون مزامنة href: كل رابط ×2 بالضبط · سلّم الطباعة: روابط 13px/leading-7 · ترويسات 11px/600
- SiteHeader.tsx: عناصر التنقل px-3→px-3.5 (+2px وفق §12) + فجوة الحاوية gap-0.5→gap-1 — الشريط 64px والدروبداون والدروار بلا تغيير
- globals.css: زجاج الكوكيز (color-mix(--card 92% فاتح/88% داكن) + backdrop-filter blur(16px) saturate(1.05) + فولباك @supports صلب) + أنماط .footer-disc summary (إخفاء marker الأصلي) — كل تعليقات التوثيق داخل الملف
- scripts/v1_contrast_matrix.py: بوابة جديدة «أسوأ-حالة الزجاج» — مزج البطاقة على تحتية تركيبية نقية (أسود تحت الفاتح/أبيض تحت الداكن): التسمية --muted-2 ‏7.58/6.87:1 والحبر --text ‏14.07/11.01:1 — كلها ≥4.5
- كاناري جديد في homepage-adoption.test.ts (+3 اختبارات): بنية الأكورديونين + الشبكة الستة + سلّم الطباعة + **قانون المزامنة** (كل href ×2) + زجاج الكوكيز وفولباكه
- البوابات: tsc ‏0 · eslint ‏0 (تحذير مسبق واحد) · vitest ‏100/1691 · build ‏2020/2020 · تباين 27/27 أخضر
- القياس الحي محليًا (next start + headless): فوتر الجوال 390px **1,273→668px** (مفتوحًا 1,213px) بالغتين EN/AR · صفوف [44,44] · صفر overflow أفقي بالوضعين واللغتين · ديسكتوب 1440: خمسة أعمدة متحاذية 165px + الروابط 13px/28px والترويسات 11px + الحشوة 14px والفجوة 4px · الكوكيز: bg شفاف 88% + blur + أزرار [44,44] + النص #C6C0B8 · فتح الأكورديون بالنقر يعمل والروابط 20 مرئية والـsummary قابل للتركيز
- VLM: ديسكتوب الفوتر 4/4 نعم (أعمدة/قراءة/ميندر/نشرة) · جوال EN أعاد بناء ما رآه حرفيًا (أكورديونا Services/Platform + كوكيز + براند) · AR داكن: قراءة سليمة وبلا كسر والزجاج «translucent not solid» — قراءة VLM خاطئة واحدة عن وجود الأكورديونين في AR دُحضت بقياس DOM المباشر (y=289/334 داخل اللقطة) — اللقطات download/v2-shots/ (7)
- DESIGN.md: §7.6 أعيدت كتابته بالكامل (كانت متقادمة حتى قبل V1 — رخام وأسماء أعمدة Phase-202 قديمة) + صفوف .footer-disc/.mhe-cookie-bar/.navbar-chrome في جدول الوصفات
- التوثيق: §25 سجل «V2 GO» بمصفوفة القياسات كاملة · STATE ‏262 (ضُغط صفا 253-255 و248-249 و247-244 لسقف 32KB — تفاصيلها بworklog) · docs/README سجل الموجات

Stage Summary:
- V2 كاملة محليًا: فوتر جوال 668px (بوابة الخروج ≤750 ✓) · VLM ‏6 سياقات ✓ · صفر overflow 390px ✓ · كل الكاناريات (القديمة بلا تعديل + 3 جديدة) خضراء
- الميندر بقي في مواضعه الثلاثة (فوتر + فاصلا الرئيسية) — قرار المالك الموثَّق §25 يعلو فوق §9.2
...
Work Log:
- التفتيش الحي بالمتصفح في 6 سياقات (EN/AR × فاتح/داكن × 1440/390): مقاييس DOM محسوبة (ارتفاعات الأقسام، أحجام الخطوط، letter-spacing، line-height، أبعاد الأزرار والبطاقات)، قياس الشبكة (صفر بايت من أصول الدارك تُجلب في الفاتح — النظام المزدوج سليم أداءً فيُحفظ)، صفر overflow أفقي، ارتفاعات الجوال (الفوتر 1,273px = 151% من الشاشة)
- تحليل بصري VLM لـ 12 لقطة كاملة + مقارنة الشعار كروم فاتح/داكن + مقارنة خط العنوان العربي (تأكيد قياس البكسل: 592.4px ≠ كايرو 613.5px)
- تحقق مستقل من ملاحظات Gemini: 5 مؤكدة (بتصحيح التفاصيل) · 4 جزئية · 3 مرفوضة · 1 غير منطبقة — مصفوفة كاملة §2 من المستند
- 18 مشكلة مؤكدة موثقة بأدلة file:line — أبرزها: خلل حي — H1 العربي يُعرض بخط serif افتراضي للنظام (utilities تتغلب على base layer في Tailwind v4 فيهزم قاعدة RTL) + tracking سالب على العربي + داكن: تناوب الأقسام غير مدرك (ΔL ‏1.5%) + حلقة التركيز نيلية مخالفة لقانون صفر-أزرق
- الخطة: نظام «Ivory & Bronze Steel» (فاتح/داكن مواطنان متساويان — جدول توكنز كامل §8.2)، إصلاح RTL النظامي §10.2، استبدال خامات الرخام وفواصل الميندر بفواصل هيكلية، تكثيف الجوال (الفوتر أكورديون، مسار ≤9,500px)، مراجعة نسخ جراحية K-1..K-7، موجات V0–V5 ببوابات §21، مخاطر/تراجع §22، وقائمة «لا تُنفذ» §23 (منها رفض تصغير H2 إلى 28-32px)
- المستند: docs/VISUAL-REDESIGN-AUDIT-2026-09-23.md + صف السجل في docs/README.md — فريم docs-only بصفر تغيير كود/أصول/منطق/SEO

Stage Summary:
- خطة إعادة التصميم البصري جاهزة للتنفيذ بجلسة مستقلة دون الحاجة لهذه المحادثة: القرارات محسومة، المفتوح للمالك O-1..O-5 له افتراضات، V0 (إصلاح خط العنوان العربي الحي) قابل للنشر المستقل فورًا
- Commit SHA: this commit carries this entry
- Push status: pushed
...
Work Log:
- النشر: /api/build-info = 855cb6e (آخر فريم) · / و/ar و/progress كلها 200
- جلسة عضو حية EN (qa.ux0922.member1): /progress تحمّلت بالكامل — أُضيف قياس ثانٍ (85.2كجم عبر حوار الإضافة الحي) ليرسم منحنى بنقطتين (+0.7 kg ظاهر) — الرسم يعمل على الكود الجديد
- حدود المنهج موثقة بصدق: توليف حركة الفأرة للتحويم على تلميح recharts أنتج غلاف tooltip نشطًا (opacity 1) بحمولة فارغة حتى منتصف الرسم — سلوك قائم لرسم بنقطتين لا علاقة له بتعديل 253 (name يعيد تسمية السلسلة عند ظهور البنود فقط — عقد recharts + tsc) — لم يُدَّعِ إثباتًا حيًا لم يحدث
- المرآة العربية حية: /progress بعد mhe:lang=ar — العناوين «الوزن عبر الزمن · سجل المراجعات · صور التقدم» + aria مبدّل اللغة «تبديل اللغة» (إصلاح 253 مثبت حيًا — وفي EN بقي "Toggle language" بالاتجاهين الصحيحين)
- **الإثبات الحي القياسي لإطار 255:** جلسة مدرب حية EN (qa.ux0922.coach1) دعوت عميلًا مسجلًا (member1) → التوست الحي: «This email is already a registered client — only the admin can assign him to you» — كان العربي الخام قبل الفريم (مقروءة من [data-sonner-toast] مباشرة — لقطة محفوظة)
- أثر بيانات وحيد موثق: قياس وزن إضافي لحساب QA العضو (85.2كجم — بيانات QA مشروعة) · محاولة الدعوة رفضها الخادم 409 (صفر إنشاء)

Stage Summary:
- المروج الحي: خط الدعوة (رمز ثابت على السلك → مُعرِّب عند العرض) يعمل من البداية للنهاية على الإنتاج
- المرحلتان 253 و255 مثبتتان حيًا بما يقبل الإثبات تفاعليًا، وحد المنهج على تلميح recharts موثق بصدق — 254 (توستات العرض) تحقق بناء الكود + البوابات ولا يتطلب تفاعلًا حيًا (رسائل حتمية بالنمط القائم المثبت حيًا في 246/250)
- Commit SHA: this commit carries this entry
- Push status: pushed ([vercel skip] — بلا نشر)
...
Work Log:
- CoachClientView (22 موقعًا + confirm + 5 throws): مسارات توليد/استرجاع الخطط (وصول المسودة · فشل التوليد · ما زالت تتولد · الاسترجاع · طلب التوليد) · الموافقة وإرسالها للعميل · تنسيق الخطة · إعادة التوليد (confirm) · حفظ الاستبيان (QuestionnaireCard — أُضيف useI18n لأن t تصل propًا بلا lang) · نافذة عرض الخطة (استبدال تمرين/صنف/يوم · إعادة توليد وجبة · حظر النافذة المنبثقة · حفظ) — النمط الموحد isAr ?: وهو القانون القائم بالملف نفسه (توست تفعيل الاشتراك 489 سبق به)
- PlansView (6): فشل حفظ الاستبدال · نجاح الاستبدال · فشله · انتهاء المهلة · طلبا استبدال الوجبة والتمرين
- BlogAdminView (5): نتيجة غير مكتملة · تعذّر تخزين المسودة · وصول المقال للمحرر · فشل التوليد · ما زال يتولد
- BlogEditorView (3): «تم التوليد من الطابور!» · فولباك «فشل التوليد» · <Label>Slug</Label> العنوان العربي الوحيد المحوّل
- الخامة الإنجليزية كتبت بأسلوب نفس الواجهة (جُمل قصيرة حتمية — رسائل الخادم تمر كما هي وفق قانون M1: التوطين عند العرض لا التزييف)
- البوابات: tsc 0 · eslint 0 (الملفات الأربعة) · vitest 99/1674 · build ✓ 2020/2020

Stage Summary:
- مدرب EN لم يعد يصطدم بعربي خام عند كل حفظ/استبدال/موافقة/إعادة توليد — أكبر عنقود من الفئات الخمس المسحوبة أُغلق بالكامل
- المتبقي من المسح: إطار 255 (أخطاء API المواجهة للعميل: invite/resend عربي خام + send-email/lead إنجليزي خام) وتقييم zod (55 موقعًا)
- Commit SHA: this commit carries this entry
- Push status: pushed (نشر تلقائي)
