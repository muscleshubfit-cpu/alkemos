...
> **آخر تحديث:** 2026-09-12 (تدقيق خارجي شامل SEO/GEO/منافسين ← خطة تنفيذ 17 إجراءً P0–P3 في `docs/SEO-GEO-MASTER-PLAN.md` §12.19 — توثيق فقط، بانتظار أوامر التنفيذ) فوق 177 (تطهير سلسلة مزودي AI + حراسة Groq json-mode + نوافذ وقت أعمق) فوق 176 فوق 175 فوق 174 فوق 173 فوق 172 فوق 171 فوق 170 فوق 168/167/166/163
...
## المفتوح الآن
- **خطة التنفيذ بعد التدقيق الخارجي جاهزة (§12.19):** P0 الأسبوع 1 = فك حظر زواحف AI في robots.txt (الحرج الوحيد — يفتح llms.txt للزواحف) + إصلاح ar/rss.xml + بتر عناوين المدونة + hreflang المدونة + نزع aggregateRating الثابت — P1 = معيار الحاسبات المزدوج + طبقة المراجعة/الكيان + مصفوفة diet-plan العربية — بانتظار أمر المالك بالبدء
...
| خطة SEO/GEO وسجل تنفيذها | `docs/SEO-GEO-MASTER-PLAN.md` §12 (خطة التنفيذ بعد التدقيق الخارجي: §12.19) |
