...
## المفتوح الآن
- **145 تفعيل (يدوي المالك — خطوة واحدة):** إضافة سر VERCEL_TOKEN (Settings → Secrets and variables → Actions) ثم تشغيل يدوي للـworkflow للتحقق — قبلها preflight يفشل برسالة تشرح الخطوة نفسها (مقصود)
