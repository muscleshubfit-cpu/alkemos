...
## المفتوح الآن
- **دفعة تصحيح المالك (§12.27–12.30) منفّذة وتنتظر الدفع/التحقق الحي:** (أ) المصفوفة ثنائية اللغة — 25 صفحة EN بتوأم hreflang كامل · (ب) صفحة `/ai-meal-planner` + مرآتها بتجربة مجانية 3/يوم/IP عبر `/api/ai/meal-plan-demo` بلا مساس بالحصص · (ج) كارتا تقييم منفصلتان (Trustpilot خضراء · PH برتقالية) · (د) أداة قائمة التسوق في المخطط · اكتشاف المصفوفة والمولد من الأدوات والرئيسية والمخطط وllms
...
- **نطاق دفعة التصحيح:** صفر ميجريشنز · المصفوفة ثنائية اللغة ببناء (نفس الحل والأرقام في اللغتين) · صفحتا المولد + مسار API بحد IP 3/يوم بلا قوائم حصص (memberships.ts لم يُلمس) · كارتا التقييم بلا props بنيوياً · أداة التسوق نقية بلا بوابة عضوية
