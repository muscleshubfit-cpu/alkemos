...
- **آخر كوميت متحقق منه:** c8bb41b (خطة التدقيق الخارجي §12.19 — docs-only، البوابات تعمل)

## المفتوح الآن
- **SEO-GEO-6.1 نفّذ P0-2/3/4/5 (§12.20):** 4 إصلاحات كود + 17 اختباراً + معالجة production لـ27 صفاً (meta_title) — **المتبقي من P0: البند 1** فك حظر 9 زواحف AI في كتلة Cloudflare المدارة (لوحة/API خارج الريبو) ثم تحقق حي بجلب robots.txt بكل UA
