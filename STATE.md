...
> **آخر تحديث:** 2026-09-08 (المرحلة 144 + 144.1 — أوامر المالك: «نجعل تسجيل الدخول بدون رسالة تاكيد كما كانت سابقا» ✓ 0074 + «شريط الكوكيز بالمعايير العالمية ورابط سياسة الخصوصية + حل الأداء» ✓ + تنفيذ مقترحات QA الحية ✓ + «حل مشكلة خطة فيرسال المجانية» ✓ تحرير Function Storage)
...
## المفتوح الآن
- **144.1 وقاية Vercel (قرار مالك معلق):** كثافة النشر ~17/يوم تعيد استنفاد الحصة خلال أيام — (أ) موافقة على GHA تنظيف أسبوعي (يحتاج سر VERCEL_TOKEN في GitHub — §3.4 مقترح غير منفذ) (ب) أو تقليص كثافة الكوميتات على main
