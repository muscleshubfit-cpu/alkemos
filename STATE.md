...
> **آخر تحديث:** 2026-09-12 (§12.37–12.38 P2-12/P2-13: مرايا USDA AR عديمة العربية تغادر الفهرس + صور جسم المدونة width/height وتصغير وقت الرسم · 810/810 · فوق §12.36 P2-11 فئات المدونة القابلة للزحف · 807/807 · فوق §12.35 مخطط التمارين بالمكتبة · 803/803) فوق دفعة المالك الثانية §12.31–12.34 فوق دفعة التصحيح §12.27–12.30 فوق P1 كاملة فوق P0 5/5 فوق تدقيق خارجي شامل فوق 177
...
## المفتوح الآن
- **§12.36–12.38 (P2-11/12/13) منفّذة:** فئات المدونة القابلة للزحف (20 صفحة) + USDA العربي (noindex لمرايا AR عديمة العربية) + صور المدونة (width/height) — بانتظار الدفع/التحقق الحي لهذه الدفعة
- **بقية P2:** البند 10 (توحيد MSA للقوالب القديمة — دفعة محتوى مستقلة) · البند 14 (إصلاحات Low: SearchAction · اتساق og:image/JSON-LD · وصف EN للكيان) · قرار ملكي مؤجل: images.unoptimized (التوصية موثقة §12.38: يبقى على المجانية)
- **§12.35 منشورة ومتحقق منها حياً · §12.31–12.34 منشورة حتى e4d1753 · §12.27–12.30 منشورة حتى dccecf3**
...
## ملخص جودة المرحلة (QA — §12.36–12.38 P2 دفعة أولى فوق §12.35)
- **البوابات التسع:** tsc 0 · eslint 0/0 · vitest **810/810** (807 + 1 USDA-AR + 2 صور المدونة) · next build exit 0 · docs_audit ✓ · docs_parity · migration_audit --ci · stale-refs · ui-wiring
- **نطاق الدفعة:** صفر ميجريشنز · صفر تغيير بيانات/مسارات (قرار noindex قابل للعكس بكوميت) · EN foods لم يُمس (سياسة 141) · صفر مساس سير عمل المدونة
