...
## 2) خريطة الترقيم 0001 → 0074 (+stub محاذاة 0072L)
...
| 0072L | `20260907124205_0072_site_coach_console.sql` | **stub محاذاة ليدجر (تعليقات فقط — صفر SQL):** تصحيح عدم التطابق الذي يوقف تكامل GitHub منذ 143.1: 0072 طُبقت عبر Management API وسُجلت بالليدجر بوقت التنفيذ (20260907124205) بينما الملف الأصلي يحمل 20260907193000 — هذا الـ stub يحمل نفس version+name المسجلين فيعود فحص «remote ⊆ local» أخضر؛ محتواه لن ينفذ أبدًا (في الليدجر أصلًا)، والملف الأصلي 0072 سيعاد تطبيقه بشكل idempotent آمن | integration |
