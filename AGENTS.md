...
> **Last updated:** 2026-09-16 (Phase 215 — BRAND NAME LAW §8 restored: the Phase-121 rebrand sweep had rewritten the forbidden legacy names into «Alkemos», neutering the law; the real pre-rebrand names are back per git history a3e2bfc4).
