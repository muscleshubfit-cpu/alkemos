...
export const MUSCLE_DEPTH: Record<string, HubDepthContent> = {
  chest: {
    ...
    guideAr:
      ...
      "تغطي مكتبتنا العضلة من كل الزوايا وبكل الأدوات: الدفع بالبار (بنش بريس بالبار، بنش مائل)، العمل بالدمبل (تمارين الذبابة لمدى الحركة المطّاطي)، الشد المستمر بالكابل (ضغط الصدر بالكابل)، وتمارين وزن الجسم (الضغط المتدرّج، والضغط الانفجاري) التي تتدرّج من أول تمرين دفع حتى المستويات المتقدمة.\n\n" +
      "خطة تدريبية مجرّبة:\n" +
      "- من 10 إلى 20 مجموعة مكثفة أسبوعيًا موزّعة على جلسين غير متتاليين\n" +
      "- 6–12 تكرارًا في الدفع، و10–15 في الذبابة، مع التوقف على بُعد 1–3 تكرارات من الفشل\n" +
  ...
  back: {
    ...
    guideAr:
      ...
      "- الرقبة والناصبات تحصل على عمل غير مباشر؛ أضف تمارين شبه المنحرفة (Shrugs) فقط إن كانت متأخرة",
    faq: [
      {
        ...
        aAr:
          "العرض يأتي من السحب الرأسي — العلق والسحب الواسع بالكامل هما العمودان. والسماكة من التجديف الأفقي — تجديف البار وتجديف الدمبلين هما العمود الفقري للعمل. أما الرفعة الميتة فتبني الناصبات وأسفل الظهر التي تؤطر البقية. سحبة رأسية وتجديفة ومفصلية في كل جلسة ظهر = قالب كامل؛ وأضف حركة أحادية كالسحب بذراع واحدة إذا كان أحد الجانبين متأخرًا.",
      },
      {
    ...
    faq: [
      {
        ...
        aAr:
          "دفعة ورفعة جانبية وحركة كتف خلفي تغطي الرؤوس الثلاثة: ضغط الكتف بالبار أو ضغط أرنولد للقوة والأمامية، والرف الجانبي بالكابل للقبعة الجانبية، وشبك الوجه أو الذبابة الخلفية بالكابل للخلفية. هذه الثلاثية بتدرّج شهري تبني كتفًا متوازنًا أفضل من أي «أفضل تمرين» منفرد. أضف تمارين شبه المنحرفة (Shrugs) إذا كانت متأخرة.",
      },
      {
  ...
  triceps: {
    ...
    guideAr:
      ...
      "تضم عائلة المكتبة (71 تمرينًا) الدفع المركّب (بنش ضيق بالبار)، والبسط بوزن الجسم (غطس على المقعد)، وعمل الكابل (دفع الترايسبس بالحبل لشد ثابت، والبسط فوق الرأس بالحبل للرأس الطويل)، والتمدد المحمّل (التمدد بمطاط المقاومة، والضغط الضيق ببار EZ).\n\n" +
      "دليل التنظيم:\n" +
