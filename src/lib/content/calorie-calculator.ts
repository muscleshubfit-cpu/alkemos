      ...
      blocks: [
        ...
        },
        {
          ...
          text: {
            ...
            ar: "نُشرت معادلتا Harris-Benedict الأصليتان عام 1919 من قياسات مخبرية على بضع مئات من الأشخاص؛ ثم نقّح Roza وShizgal ثوابتَها عام 1984. النسخة المنقحة للذكور: BMR = 88.362 + 13.397 × الوزن(كجم) + 4.799 × الطول(سم) − 5.677 × العمر؛ وللإناث: BMR = 447.593 + 9.247 × الوزن(كجم) + 3.098 × الطول(سم) − 4.330 × العمر. المشكلة هي الانحراف: فالأشخاص الذين قياسوا قبل قرن كانوا أنحف لكل كيلوغرام من الناس اليوم، لذا تبالغ Harris-Benedict منهجياً في تقدير احتياجات الطاقة للبالغين المعاصرين — غالباً بنسبة 5% أو أكثر. ما تزال مواقع شائعة كثيرة تستخدمها، وهذا أحد أسباب كون أرقامها أعلى من أرقامنا للمدخلات نفسها.",
          },
        },
        {
          kind: "h3",
