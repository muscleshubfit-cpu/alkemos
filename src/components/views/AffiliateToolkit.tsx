...
function getUi(isAr: boolean): UiStrings {
  if (isAr) {
    return {
      link: {
        title: "رابط الأفلييت الخاص بك",
        subtitle:
          "استخدم هذا الرابط في كل مكان توصي فيه بـ Alkemos. كل عملية شراء مؤهلة تتم عن طريقه تُسجّل في حسابك.",
        ...
        error: "تعذر النسخ",
        note:
          "هذا الرابط مرتبط بحسابك وحده؛ لا تشاركه مع أي شخص آخر، فأي تعديل عليه يُفقد التتبع.",
      },
      content: {
        title: "محتوى جاهز للنشر",
        subtitle:
          "نصوص جاهزة ومناسبة لكل منصة، ويتضمن كل نص رابطك الفعلي. لا تُعدّل النصوص بما يخالف الإفصاح عن الأفلييت.",
      },
      banners: {
        title: "بانرات للموقع",
        subtitle:
          "بانرات جاهزة للتركيب على موقعك أو مدونتك، ويتضمن كل بانر كود HTML جاهزًا للنسخ مباشرة.",
        langSelector: {
          title: "لغة البانر",
          en: "إنجليزي",
          ar: "عربي",
          hint: "اختر اللغة التي سيراها زوار موقعك داخل البانر.",
        },
      },
      common: {
        copied: "تم النسخ ✓",
