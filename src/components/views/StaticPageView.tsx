...
function getContent(page: string, isAr: boolean) {
 ...
 { heading: "من هو EVO؟", paragraphs: ["EVO هو محرك الأداء الذكي. يقرأ بياناتك وهدفك، يبني لك خطط تغذية وتمارين مخصصة، ويقترح تبديلات ذكية للوجبات والتمارين. متاح للجميع، للزوار والأعضاء على حد سواء، وفق حدود الاستخدام."] },
 ...
 { heading: "Who is EVO?", paragraphs: ["EVO is the AI performance engine. It reads your data and goal, builds personalized nutrition and workout plans, and suggests smart meal and exercise swaps. Available to everyone — visitors and members alike — with tier-based limits."] },
