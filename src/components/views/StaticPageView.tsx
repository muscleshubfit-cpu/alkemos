...
function getContent(page: string, isAr: boolean) {
 ...
 { heading: "العضويات", paragraphs: ["Alkemos تقدم 3 باقات: مجاني (وصول محدود)، بريميوم $14.99/شهر أو $119/سنة (EVO غير محدود + خطط شهرية)، برو $29.99/شهر أو $239/سنة (8 توليدات خطط AI شهريًا + بدون إعلانات). وكوتشينج بشري منفصل بـ $39.99/شهر أو $359/سنة للمهتمين بمتابعة فردية."] },
 ],
 } : {
 title: "About Alkemos",
 ...
 { heading: "Memberships", paragraphs: ["Alkemos offers 3 tiers: Free (limited access), Premium $14.99/mo or $119/yr (unlimited EVO + monthly plans), Pro $29.99/mo or $239/yr (8 AI plan generations/month + no ads). Human coaching is available separately at $39.99/mo or $359/yr for those who want 1-on-1 supervision."] },
 ],
 };
 }
 ...
 { heading: "التبديلات", paragraphs: ["حد التبديلات الأسبوعي يعتمد على باقتك:", "مجاني: لا يوجد. بريميوم: 3 تبديلات/أسبوع. برو: 6 تبديلات/أسبوع. كوتشينج: 6 تبديلات/أسبوع.", "التبديلات تتجدد كل اثنين."] },
 ...
 { heading: "Swaps", paragraphs: ["Weekly swap limits depend on your plan:", "Free: none. Premium: 3 swaps/week. Pro: 6 swaps/week. Coaching: 6 swaps/week.", "Swaps reset every Monday."] },
 ...
 { heading: "هل بياناتي آمنة؟", paragraphs: ["نعم. البيانات مشفرة على Supabase ومحمية بسياسات الأمان على مستوى الصفوف (RLS): تظهر لك وللمدرب المعيّن لك، ويمكن لفريق المنصة المُصرّح له الوصول إليها فقط في نطاقات محدودة كالدعم والتشغيل."] },
 ...
 { heading: "كم يستغرق رؤية نتائج؟", paragraphs: ["تختلف النتائج من شخص لآخر حسب الانتظام ونقطة البداية والأهداف. توفر Alkemos أدوات وإرشادًا منظمًا لمساعدتك على تحقيق تقدم قابل للقياس مع الوقت."] },
 ],
 } : {
 ...
 { heading: "How many weekly swaps?", paragraphs: ["Free: 0. Premium: 3 swaps/week. Pro: 6 swaps/week. Coaching: 6 swaps/week. Resets every Monday."] },
 ...
 { heading: "Is my data secure?", paragraphs: ["Yes. Data is encrypted on Supabase and protected by Row Level Security policies: your records are visible to you and your assigned coach, and authorized platform staff can access them only in limited support and operations contexts."] },
