...
export const viewport: Viewport = {
  // EMBER-INK-279: the identity is the 1devtool landing-fitness-studio
  // template — dark-ONLY. Both scheme branches carry the ink ground
  // #08080A (globals.css tokens resolve both data-theme values to the
  // same palette); the pair format stays for the two-value spec.
  themeColor: [
