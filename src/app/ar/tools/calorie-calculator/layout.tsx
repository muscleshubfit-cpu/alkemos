...
export const metadata: Metadata = {
  ...
  description:
    "احسب سعراتك الحرارية اليومية والماكروز (بروتين، كارب، دهون) مجانًا بناءً على وزنك وطولك وعمرك ونشاطك، بمعادلة ميفلين-سانت جيور (Mifflin-St Jeor) الأدق — نتائج فورية وشرح مبسط.",
  keywords: [
