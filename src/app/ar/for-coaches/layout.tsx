...
export const metadata: Metadata = {
  title: "انضم كمدرب في Alkemos — درِّب عملاءك بأسعارك وفلوسك بين يديك",
  description:
    "سجّل كمدرب أو أخصائي تغذية على Alkemos مجانًا: منصة كاملة لإدارة عملائك أنت، خطط تغذية وتمارين بالذكاء الاصطناعي، تحدد سعرك بنفسك وتحصّل من عملائك مباشرة بدون أي نسبة — رسم تفعيل شهري ثابت فقط. تفعيل فوري.",
  keywords: [
    "انضم كمدرب",
    "تسجيل مدرب",
    "شغل كوتش اونلاين",
  ...
  openGraph: {
    title: "انضم كمدرب في Alkemos — درِّب عملاءك بأسعارك وفلوسك بين يديك",
    description:
      "منصة كاملة للمدربين: إدارة عملائك، خطط بالذكاء الاصطناعي، أسعارك تختارها أنت وتحصّلها بنفسك — بدون أي نسبة من دخلك. سجّل مجانًا بتفعيل فوري.",
  ...
  twitter: {
    ...
    title: "انضم كمدرب في Alkemos — عملاؤك بأسعارك وفلوسك بين يديك",
    description:
