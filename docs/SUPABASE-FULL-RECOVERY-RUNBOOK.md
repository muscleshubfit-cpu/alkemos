...
**الحاويات (Buckets) — الحقيقة الحية المقاسة أول مرة بالجرد الآلي 2026-09-20 (9 حاويات، وليست 4 كما في الميجريشنز فقط):**
...
- على مشروع جديد: تعريف الحاويات الأربع الموثقة يأتي من المسار اليدوي أعلاه (0027 + 0037) — **الحاويات الليجاسي الخمس لن تُنشأ تلقائيًا** (لا ميجريشن لها)؛ إن كان محتواها مطلوبًا فهو أصلًا ضمن نطاق «الملفات غير القابلة للاستعادة» (B4) وقرار المالك في P0-3(ج) يشملها.
