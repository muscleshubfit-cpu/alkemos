...
- على مشروع جديد: تعريف الحاويات الخمس الموثقة يأتي من المسارين أعلاه (0027 + 0037) + ميجريشن 0090 الآلي (`avatars`) — **الحاويات الليجاسي الخمس لن تُنشأ تلقائيًا** (لا ميجريشن لها)؛ إن كان محتواها مطلوبًا فهو أصلًا ضمن نطاق «الملفات غير القابلة للاستعادة» (B4) وقرار المالك في P0-3(ج) يشملها.
